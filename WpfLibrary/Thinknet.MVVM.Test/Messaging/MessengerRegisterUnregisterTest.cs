namespace Thinknet.MVVM.Test.Messaging
{
    ...
    public class MessengerRegisterUnregisterTest
    {
        ...
        public DateTime ReceivedContentDateTime1 { get; private set; }

        public DateTime ReceivedContentDateTime2 { get; private set; }

        public Exception ReceivedContentException { get; private set; }

        public int ReceivedContentInt { get; private set; }

        public string ReceivedContentStringA1 { get; private set; }

        public string ReceivedContentStringA2 { get; private set; }

        public string ReceivedContentStringB { get; private set; }
        ...
        public void TestRegisterStrictAndNonStrictRecipients()
        {
            ...
            Messenger.Default.Register<TestMessageGeneric<DateTime>>(
                this, 
                m =>
                    {
                        receivedMessages++;
        ...
        {
            public string ReceivedContentA { get; private set; }

            public string ReceivedContentB { get; private set; }
