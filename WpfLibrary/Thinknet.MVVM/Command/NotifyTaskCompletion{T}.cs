namespace Thinknet.MVVM.Command
{
    ...
    /// </remarks>
    public class NotifyTaskCompletion<TResult> : BindingBase, INotifyTaskCompletion<TResult>
    {
        ...
        /// </param>
        public NotifyTaskCompletion(Task<TResult> task, TaskScheduler scheduler) 
        {
            _task = task;
            if (task.IsCompleted)
            {
