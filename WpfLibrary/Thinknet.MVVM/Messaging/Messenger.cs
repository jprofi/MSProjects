namespace Thinknet.MVVM.Messaging
{
    ...
    {
        private static IMessenger _defaultInstance = new Messenger();
        ...
        /// <summary>
        /// Sets the Messenger's default (static) instance to a new instance.
        /// Not use this funcion in production code, just for unit tests.
        /// </summary>
            ...
            Action<TMessage> action)
        {
            lock (_registerLock)
            {
                ...
                lock (recipients)
                {
                    ...
                    WeakAction weakAction = new WeakAction<TMessage>(recipient, action);
            ...
            object token)
        {
            if (weakActionsAndTokens != null)
            {
                ...
                IEnumerable<WeakActionAndToken> list = weakActionsAndTokens.ToList();
                IEnumerable<WeakActionAndToken> listClone = list.Take(list.Count()).ToList();
