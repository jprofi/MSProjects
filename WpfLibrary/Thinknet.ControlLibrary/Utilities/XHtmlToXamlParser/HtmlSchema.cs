namespace Thinknet.ControlLibrary.Utilities.XHtmlToXamlParser
{
    ...
    internal class HtmlSchema
    {
        ...
        /// <returns>Whether the element name represents a block element.</returns>
        ...
        /// </summary>
        /// <param name="xmlElementName">The name of the xml element.</param>
        /// <returns>Whether the element name represents an inline element.</returns>
        ...
        /// </summary>
        /// <param name="xmlElementName">The name of the xml element.</param>
        /// <returns>Whether the element name represents an openable element.</returns>
        ...
        /// <param name="nextElementName">The next Element Name.</param>
        internal static bool ClosesOnNextElementStart(string currentElementName, string nextElementName)
        {
            Contract.Assert(currentElementName == currentElementName.ToLower());
