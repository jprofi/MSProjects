namespace Thinknet.ControlLibrary.Utilities.XHtmlToXamlParser
{
    ...
    public static class HtmlToXamlConverter
    {
        ...
        // Regex for finding CrLf followed by whitespaces.
        private static readonly Regex regexCrLfWs = new Regex(@"\r|\n\s*");
        ...
        /// </summary>
        /// <param name="xDocument">Well formed XHTML as XDocument.</param>
        ...
        /// </returns>
        public static string ConvertXHtmlToXaml(XDocument xDocument, bool asFlowDocument)
        {
            ...
            string rootElementName = asFlowDocument ? XamlProperties.XamlFlowDocument : XamlProperties.XamlSection;

            // Create an XmlDocument for generated xaml
            XmlDocument xamlTree = new XmlDocument();
            XmlElement xamlFlowDocumentElement = xamlTree.CreateElement(null, rootElementName, XamlProperties.XamlNamespace);
            ...
            AddBlock(xamlFlowDocumentElement, xmlElement, new Hashtable(), stylesheet, sourceContext);
        ...
        /// </param>
        /// <param name="inheritedProperties">Properties inherited from an outer context.</param>
        ...
        private static XmlNode AddBlock(XmlElement xamlParentElement, XmlNode htmlNode, Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            else if (htmlNode is XmlElement)
            {
                ...
                if (htmlElementNamespace != XhtmlNamespace)
                {
                ...
                Contract.Assert(sourceContext.Count > 0 && sourceContext[sourceContext.Count - 1] == htmlElement);
        ...
        private static void AddBreak(XmlElement xamlParentElement, string htmlElementName)
        {
            ...
            XmlDocument ownerDocument = xamlParentElement.OwnerDocument;
            if (ownerDocument != null)
            {
                XmlElement xamlLineBreak = ownerDocument.CreateElement(/*prefix:*/null, /*localName:*/XamlProperties.XamlLineBreak, XamlProperties.XamlNamespace);
                xamlParentElement.AppendChild(xamlLineBreak);
                if (htmlElementName == "hr")
                {
                    XmlText xamlHorizontalLine = ownerDocument.CreateTextNode("----------------------");
                    xamlParentElement.AppendChild(xamlHorizontalLine);
                    xamlLineBreak = ownerDocument.CreateElement(/*prefix:*/null, /*localName:*/XamlProperties.XamlLineBreak, XamlProperties.XamlNamespace);
                    xamlParentElement.AppendChild(xamlLineBreak);
                }
            }
        }
        ...
        private static void AddSection(XmlElement xamlParentElement, XmlElement htmlElement, Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            else
            {
                ...
                if (ownerDocument != null)
                {
                    XmlElement xamlElement = ownerDocument.CreateElement(/*prefix:*/null, /*localName:*/XamlProperties.XamlSection, XamlProperties.XamlNamespace);
        ...
        private static void AddParagraph(XmlElement xamlParentElement, XmlElement htmlElement, Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            {
                // Create a XAML element corresponding to this html element
                XmlElement xamlElement = ownerDocument.CreateElement(/*prefix:*/null, /*localName:*/XamlProperties.XamlParagraph, XamlProperties.XamlNamespace);
                ApplyLocalProperties(xamlElement, localProperties, /*isBlock:*/true);
        ...
        {
            XmlNode lastNodeProcessed = htmlNode;
            XmlDocument ownerDocument = xamlParentElement.OwnerDocument;
            if (ownerDocument != null)
            {
                // Collect all non-block elements and wrap them into implicit Paragraph
                XmlElement xamlParagraph = ownerDocument.CreateElement(/*prefix:*/null, /*localName:*/XamlProperties.XamlParagraph, XamlProperties.XamlNamespace);
                while (htmlNode != null)
                {
                    if (htmlNode is XmlComment)
                    {
        ...
        private static void AddInline(XmlElement xamlParentElement, XmlNode htmlNode, Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            {
                // Remove Control chars from value if any.
                string value = regexCrLfWs.Replace(htmlNode.Value, string.Empty);
                AddTextRun(xamlParentElement, value);
            }
            else if (htmlNode is XmlElement)
            {
                XmlElement htmlElement = (XmlElement)htmlNode;
                ...
                if (htmlElement.NamespaceURI != XhtmlNamespace)
                {
        ...
        private static void AddSpanOrRun(XmlElement xamlParentElement, XmlElement htmlElement, Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            string xamlElementName = elementHasChildren ? XamlProperties.XamlSpan : XamlProperties.XamlRun;
            ...
            {
                // Create a XAML element corresponding to this html element
                XmlElement xamlElement = ownerDocument.CreateElement(/*prefix:*/null, /*localName:*/xamlElementName, XamlProperties.XamlNamespace);
        ...
        private static void AddTextRun(XmlElement xamlElement, string textData)
        {
            ...
            {
                XmlDocument ownerDocument = xamlElement.OwnerDocument;
                if (ownerDocument != null)
                {
                    xamlElement.AppendChild(ownerDocument.CreateTextNode(textData));
                }
            }
        }
        ...
        private static void AddHyperlink(XmlElement xamlParentElement, XmlElement htmlElement, Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            string href = XmlHelper.GetAttribute(htmlElement, "href");
            if (href == null)
            {
            ...
            else
            {
                ...
                {
                    // Create a XAML element corresponding to this html element
                    XmlElement xamlElement = ownerDocument.CreateElement(/*prefix:*/null, /*localName:*/XamlProperties.XamlHyperlink, XamlProperties.XamlNamespace);
                    ApplyLocalProperties(xamlElement, localProperties, /*isBlock:*/false);

                    string[] hrefParts = href.Split(new[] { '#' });
                    if (hrefParts.Length > 0 && hrefParts[0].Trim().Length > 0)
                    {
                        xamlElement.SetAttribute(XamlProperties.XamlHyperlinkNavigateUri, hrefParts[0].Trim());
                    }

                    if (hrefParts.Length == 2 && hrefParts[1].Trim().Length > 0)
                    {
                        xamlElement.SetAttribute(XamlProperties.XamlHyperlinkTargetName, hrefParts[1].Trim());
                    }
        ...
        private static XmlElement ExtractInlineFragment(XmlElement xamlFlowDocumentElement)
        {
            ...
            {
                if (_inlineFragmentParentElement.LocalName == XamlProperties.XamlSpan)
                {
                    xamlFlowDocumentElement = _inlineFragmentParentElement;
                }
                else
                {
                    XmlDocument ownerDocument = xamlFlowDocumentElement.OwnerDocument;
                    if (ownerDocument != null)
                    {
                        xamlFlowDocumentElement = ownerDocument.CreateElement(/*prefix:*/null, /*localName:*/XamlProperties.XamlSpan, XamlProperties.XamlNamespace);
        ...
        private static void AddList(XmlElement xamlParentElement, XmlElement htmlListElement, Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            if (ownerDocument != null)
            {
                ...
                XmlElement xamlListElement = ownerDocument.CreateElement(null, XamlProperties.XamlList, XamlProperties.XamlNamespace);

                // Set default list markers
                if (htmlListElementName == "ol")
                {
                    // Ordered list
                    xamlListElement.SetAttribute(XamlProperties.XamlListMarkerStyle, XamlProperties.XamlListMarkerStyleDecimal);
                }
                else
                {
                    // Unordered list - all elements other than OL treated as unordered lists
                    xamlListElement.SetAttribute(XamlProperties.XamlListMarkerStyle, XamlProperties.XamlListMarkerStyleDisc);
                }
                ...
                for (XmlNode htmlChildNode = htmlListElement.FirstChild; htmlChildNode != null; htmlChildNode = htmlChildNode.NextSibling)
                {
                    if (htmlChildNode is XmlElement && (htmlChildNode.LocalName.ToLower() == "li"))
                    {
                        ...
                        Contract.Assert(sourceContext.Count > 0 && sourceContext[sourceContext.Count - 1] == htmlChildNode);
                        sourceContext.RemoveAt(sourceContext.Count - 1);
                    }
                }
        ...
        /// <param name="htmlLiElement">Start Html li element without parent list</param>
        /// <param name="inheritedProperties">Properties inherited from parent context</param>
        /// <param name="stylesheet">The stylesheet.</param>
        /// <param name="sourceContext">The source Context.</param>
        /// <returns>
        ...
        {
            Contract.Assert(htmlLiElement.LocalName.ToLower() == "li");
            ...
            if (xamlListItemElementPreviousSibling != null && xamlListItemElementPreviousSibling.LocalName == XamlProperties.XamlList)
            {
            ...
            else
            {
                ...
                xamlListElement = xamlParentElement.OwnerDocument.CreateElement(null, XamlProperties.XamlList, XamlProperties.XamlNamespace);
                xamlParentElement.AppendChild(xamlListElement);
            }
        ...
        private static void AddListItem(XmlElement xamlListElement, XmlElement htmlLiElement, Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            Contract.Assert(xamlListElement != null);
            Contract.Assert(xamlListElement.LocalName == XamlProperties.XamlList);
            Contract.Assert(htmlLiElement != null);
            //Contract.Assert(htmlLIElement.LocalName.ToLower() == "li");
            Contract.Assert(inheritedProperties != null);
            ...
            XmlDocument ownerDocument = xamlListElement.OwnerDocument;
            if (ownerDocument != null)
            {
                XmlElement xamlListItemElement = ownerDocument.CreateElement(null, XamlProperties.XamlListItem, XamlProperties.XamlNamespace);
        ...
        /// <param name="inheritedProperties">Hashtable representing properties inherited from parent context.</param>
        /// <param name="stylesheet">The stylesheet.</param>
        /// <param name="sourceContext">The source Context.</param>
        ...
        {
            // Parameter validation
            Contract.Assert(htmlTableElement.LocalName.ToLower() == "table");
            Contract.Assert(xamlParentElement != null);
            Contract.Assert(inheritedProperties != null);
            ...
            if (singleCell != null)
            {
                ...
                Contract.Assert(sourceContext.Count > 0 && sourceContext[sourceContext.Count - 1] == singleCell);
                sourceContext.RemoveAt(sourceContext.Count - 1);
            }
            else
            {
                // Create xamlTableElement
                XmlElement xamlTableElement = xamlParentElement.OwnerDocument.CreateElement(null, XamlProperties.XamlTable, XamlProperties.XamlNamespace);
                ...
                while (htmlChildNode != null)
                {
                    ...
                    if (htmlChildName == "tbody" || htmlChildName == "thead" || htmlChildName == "tfoot")
                    {
                        ...
                        XmlElement xamlTableBodyElement = xamlTableElement.OwnerDocument.CreateElement(null, XamlProperties.XamlTableRowGroup, XamlProperties.XamlNamespace);
        ...
        /// </summary>
        /// <param name="htmlTableElement">XmlElement representing a source html table.</param>
        /// <param name="xamlTableElement">XmlElement repesenting a resulting xaml table.</param>
        ...
        /// <param name="stylesheet">The stylesheet.</param>
        /// <param name="sourceContext">The source Context.</param>
        private static void AddColumnInformation(XmlNode htmlTableElement, XmlElement xamlTableElement, ArrayList columnStartsAllRows, Hashtable currentProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            if (columnStartsAllRows != null)
            {
                ...
                {
                    XmlElement xamlColumnElement = xamlTableElement.OwnerDocument.CreateElement(null, XamlProperties.XamlTableColumn, XamlProperties.XamlNamespace);
                    xamlColumnElement.SetAttribute(XamlProperties.XamlWidth, ((double)columnStartsAllRows[columnIndex + 1] - (double)columnStartsAllRows[columnIndex]).ToString(CultureInfo.InvariantCulture));
        ...
        /// </summary>
        /// <param name="xamlTableElement">The xml table element</param>
        /// <param name="htmlColElement">XmlElement representing Html col element to be converted</param>
        /// <param name="inheritedProperties">properties inherited from parent context</param>
        /// <param name="stylesheet">The stylesheet.</param>
        /// <param name="sourceContext">The source Context.</param>
        private static void AddTableColumn(XmlElement xamlTableElement, XmlElement htmlColElement, Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            XmlElement xamlTableColumnElement = xamlTableElement.OwnerDocument.CreateElement(null, XamlProperties.XamlTableColumn, XamlProperties.XamlNamespace);
        ...
        /// </summary>
        /// <param name="xamlTableBodyElement">XmlElement representing Xaml TableRowGroup element to which the converted rows should be added</param>
        /// <param name="htmlTrStartNode">XmlElement representing the first tr child of the tbody element to be read</param>
        ...
        /// </param>
        /// <param name="columnStarts">The column Starts.</param>
        /// <param name="stylesheet">The stylesheet.</param>
        /// <param name="sourceContext">The source Context.</param>
        /// <returns>
        ...
        {
            // Parameter validation
            Contract.Assert(xamlTableBodyElement.LocalName == XamlProperties.XamlTableRowGroup);
            Contract.Assert(currentProperties != null);
            ...
            while (htmlChildNode != null && htmlChildNode.LocalName.ToLower() != "tbody")
            {
                ...
                {
                    XmlElement xamlTableRowElement = xamlTableBodyElement.OwnerDocument.CreateElement(null, XamlProperties.XamlTableRow, XamlProperties.XamlNamespace);
                ...
                else if (htmlChildNode.LocalName.ToLower() == "td")
                {
                    ...
                    Contract.Assert(columnStarts == null);
        ...
        /// </param>
        /// <param name="htmlTDStartNode">XmlElement representing the child of tr or tbody element from which we should start adding td elements</param>
        /// <param name="currentProperties">properties of the current html tr element to which cells are to be added</param>
        /// <param name="columnStarts">The column Starts.</param>
        /// <param name="activeRowSpans">The active Row Spans.</param>
        /// <param name="stylesheet">The stylesheet.</param>
        /// <param name="sourceContext">The source Context.</param>
        /// <returns>
        ...
        {
            // parameter validation
            Contract.Assert(xamlTableRowElement.LocalName == XamlProperties.XamlTableRow);
            Contract.Assert(currentProperties != null);
            if (columnStarts != null)
            {
                Contract.Assert(activeRowSpans.Count == columnStarts.Count);
            }
            ...
            while (htmlChildNode != null && htmlChildNode.LocalName.ToLower() != "tr" && htmlChildNode.LocalName.ToLower() != "tbody" && htmlChildNode.LocalName.ToLower() != "thead" && htmlChildNode.LocalName.ToLower() != "tfoot")
            {
                ...
                {
                    XmlElement xamlTableCellElement = xamlTableRowElement.OwnerDocument.CreateElement(null, XamlProperties.XamlTableCell, XamlProperties.XamlNamespace);
                    ...
                    if (columnStarts != null)
                    {
                        Contract.Assert(columnIndex < columnStarts.Count - 1);
                        while (columnIndex < activeRowSpans.Count && (int)activeRowSpans[columnIndex] > 0)
                        {
                            ...
                            Contract.Assert((int)activeRowSpans[columnIndex] >= 0);
                            columnIndex++;
                        }
                        ...
                        Contract.Assert(columnSpan > 0);
                        Contract.Assert(columnIndex + columnSpan < columnStarts.Count);

                        xamlTableCellElement.SetAttribute(XamlProperties.XamlTableCellColumnSpan, columnSpan.ToString());
                        
                        // Apply row span
                        for (int spannedColumnIndex = columnIndex; spannedColumnIndex < columnIndex + columnSpan; spannedColumnIndex++)
                        {
                            Contract.Assert(spannedColumnIndex < activeRowSpans.Count);
                            activeRowSpans[spannedColumnIndex] = rowSpan - 1;
                            Contract.Assert((int)activeRowSpans[spannedColumnIndex] >= 0);
                        }
        ...
        {
            // Parameter validation
            Contract.Assert(xamlTableCellElement.LocalName == XamlProperties.XamlTableCell);
            Contract.Assert(currentProperties != null);
        ...
        /// </summary>
        /// <param name="htmlTableElement">XmlElement representing Html table whose structure is to be analyzed</param>
        /// <param name="stylesheet">The stylesheet.</param>
        /// <returns>
        ...
        private static ArrayList AnalyzeTableStructure(XmlElement htmlTableElement, CssStylesheet stylesheet)
        {
            ...
            Contract.Assert(columnStarts.Count == activeRowSpans.Count);
        ...
        /// </summary>
        /// <param name="htmlTbodyElement">XmlElement representing Html tbody whose structure is to be analyzed</param>
        /// <param name="columnStarts">ArrayList of type double which contains the function output. If analysis fails, this parameter is set to null</param>
        /// <param name="activeRowSpans">The active Row Spans.</param>
        ...
        {
            // Parameter validation
            Contract.Assert(htmlTbodyElement.LocalName.ToLower() == "tbody");
            Contract.Assert(columnStarts != null);
        ...
        private static double AnalyzeTrStructure(XmlElement htmlTrElement, ArrayList columnStarts, ArrayList activeRowSpans, double tableWidth, CssStylesheet stylesheet)
        {
            ...
            // Parameter validation
            Contract.Assert(htmlTrElement.LocalName.ToLower() == "tr");
            Contract.Assert(columnStarts != null);
            Contract.Assert(activeRowSpans != null);
            Contract.Assert(columnStarts.Count == activeRowSpans.Count);
            ...
            {
                Contract.Assert((double)columnStarts[columnIndex] >= columnStart);
            ...
            while (htmlChildNode != null && columnWidthsAvailable)
            {
                ...
                {
                    case "td":
                        Contract.Assert(columnIndex <= columnStarts.Count);
                        if (columnIndex < columnStarts.Count)
                        {
                            Contract.Assert(columnStart <= (double)columnStarts[columnIndex]);
                        ...
                        if (columnWidth != -1)
                        {
                            ...
                            if (nextColumnIndex != -1)
                            {
                                ...
                                Contract.Assert(nextColumnIndex <= columnStarts.Count);
        ...
        private static int GetRowSpan(XmlElement htmlTdElement)
        {
            ...
            rowSpanAsString = XmlHelper.GetAttribute(htmlTdElement, "rowspan");
        ...
        /// <param name="activeRowSpans">The active Row Spans.</param>
        /// <returns>The index for column inserting.</returns>
        private static int GetNextColumnIndex(int columnIndex, double columnWidth, ArrayList columnStarts, ArrayList activeRowSpans)
        {
            ...
            // Parameter validation
            Contract.Assert(columnStarts != null);
            Contract.Assert(0 <= columnIndex && columnIndex <= columnStarts.Count);
            Contract.Assert(columnWidth > 0);
        ...
        {
            // Parameter validation
            Contract.Assert(htmlTDElement.LocalName.ToLower() == "td" || htmlTDElement.LocalName.ToLower() == "th");
            Contract.Assert(columnStart >= 0);

            double nextColumnStart = -1;
        ...
        private static double GetColumnWidth(XmlElement htmlTdElement)
        {
            ...
            columnWidthAsString = XmlHelper.GetAttribute(htmlTdElement, "width");
            if (columnWidthAsString == null)
            {
                columnWidthAsString = GetCssAttribute(XmlHelper.GetAttribute(htmlTdElement, "style"), CssProperties.Width);
            }
        ...
        private static int CalculateColumnSpan(int columnIndex, double columnWidth, ArrayList columnStarts)
        {
            ...
            Contract.Assert(columnStarts != null);
            Contract.Assert(columnIndex < columnStarts.Count - 1);
            Contract.Assert((double)columnStarts[columnIndex] >= 0);
            Contract.Assert(columnWidth > 0);
            ...
            while (columnSpanningValue < columnWidth && columnSpanningIndex < columnStarts.Count - 1)
            {
                ...
                Contract.Assert(subColumnWidth > 0);
        ...
        /// </summary>
        /// <param name="xamlElement">XmlElement representing Xaml element to which properties are to be applied</param>
        /// <param name="localProperties">Hashtable representing local properties of Html element that is converted into xamlElement</param>
        ...
        private static void ApplyLocalProperties(XmlElement xamlElement, Hashtable localProperties, bool isBlock)
        {
            ...
            while (propertyEnumerator.MoveNext())
            {
                switch ((string)propertyEnumerator.Key)
                {
                    case CssProperties.FontFamily:
                        ...
                        xamlElement.SetAttribute(XamlProperties.XamlFontFamily, (string)propertyEnumerator.Value);
                        break;
                    case CssProperties.FontStyle:
                        xamlElement.SetAttribute(XamlProperties.XamlFontStyle, (string)propertyEnumerator.Value);
                        break;
                    case CssProperties.FontVariant:
                        //  Convert from font-variant into xaml property
                        break;
                    case CssProperties.FontWeight:
                        xamlElement.SetAttribute(XamlProperties.XamlFontWeight, (string)propertyEnumerator.Value);
                        break;
                    case CssProperties.FontSize:
                        //  Convert from css size into FontSize
                        xamlElement.SetAttribute(XamlProperties.XamlFontSize, (string)propertyEnumerator.Value);
                        break;
                    ...
                    case CssProperties.TextDecoration:
                        if (!isBlock)
                        {
                            if ((string)propertyEnumerator.Value == CssProperties.TextDecorationUnderlineValue)
                            {
                                xamlElement.SetAttribute(XamlProperties.XamlTextDecorations, XamlProperties.XamlTextDecorationsUnderline);
                            }
                        }
                    ...
                    case CssProperties.TextIndent:
                        if (isBlock)
                        {
                            xamlElement.SetAttribute(XamlProperties.XamlTextIndent, (string)propertyEnumerator.Value);
                        }
                    ...
                    case CssProperties.TextAlign:
                        if (isBlock)
                        {
                            xamlElement.SetAttribute(XamlProperties.XamlTextAlignment, (string)propertyEnumerator.Value);
                        }

                        break;

                    case CssProperties.BaselineAlign:
                        {
                            xamlElement.SetAttribute(XamlProperties.XamlBaselineAlignment, (string)propertyEnumerator.Value);
                        }
                    ...
                    case "list-style-type":
                        if (xamlElement.LocalName == XamlProperties.XamlList)
                        {
                            string markerStyle;
                            switch (((string)propertyEnumerator.Value).ToLower())
                            {
                                case "disc":
                                    markerStyle = XamlProperties.XamlListMarkerStyleDisc;
                                    break;
                                case "circle":
                                    markerStyle = XamlProperties.XamlListMarkerStyleCircle;
                                    break;
                                case "none":
                                    markerStyle = XamlProperties.XamlListMarkerStyleNone;
                                    break;
                                case "square":
                                    markerStyle = XamlProperties.XamlListMarkerStyleSquare;
                                    break;
                                case "box":
                                    markerStyle = XamlProperties.XamlListMarkerStyleBox;
                                    break;
                                case "lower-latin":
                                    markerStyle = XamlProperties.XamlListMarkerStyleLowerLatin;
                                    break;
                                case "upper-latin":
                                    markerStyle = XamlProperties.XamlListMarkerStyleUpperLatin;
                                    break;
                                case "lower-roman":
                                    markerStyle = XamlProperties.XamlListMarkerStyleLowerRoman;
                                    break;
                                case "upper-roman":
                                    markerStyle = XamlProperties.XamlListMarkerStyleUpperRoman;
                                    break;
                                case "decimal":
                                    markerStyle = XamlProperties.XamlListMarkerStyleDecimal;
                                    break;
                                default:
                                    markerStyle = XamlProperties.XamlListMarkerStyleDisc;
                                    break;
                            ...
                            xamlElement.SetAttribute(XamlProperties.XamlListMarkerStyle, markerStyle);
                        }
            ...
            if (isBlock)
            {
                if (marginSet)
                {
                    ComposeThicknessProperty(xamlElement, XamlProperties.XamlMargin, marginLeft, marginRight, marginTop, marginBottom);
                }

                if (paddingSet)
                {
                    ComposeThicknessProperty(xamlElement, XamlProperties.XamlPadding, paddingLeft, paddingRight, paddingTop, paddingBottom);
                }

                if (borderColor != null)
                {
                    //  We currently ignore possible difference in brush colors on different border sides. Use the last colored side mentioned
                    xamlElement.SetAttribute(XamlProperties.XamlBorderBrush, borderColor);
                }

                if (borderThicknessSet)
                {
                    ComposeThicknessProperty(xamlElement, XamlProperties.XamlBorderThickness, borderThicknessLeft, borderThicknessRight, borderThicknessTop, borderThicknessBottom);
                }
            }
        }
        ...
        private static void SetPropertyValue(XmlElement xamlElement, DependencyProperty property, string stringValue)
        {
            ...
            {
                // todo tb: Logging
                //log.Error(e, "Error while setting property value: {0}, {1}", property.Name, stringValue);
                throw e;
            }
        }
        ...
        /// </summary>
        /// <param name="htmlElement">The element for property analysis</param>
        /// <param name="inheritedProperties">set of properties inherited from ancestor elements. Currently not used in the code. Reserved for the future development.</param>
        /// <param name="localProperties">returns all formatting properties defined by this element - implied by its tag, its attributes, or its css inline style</param>
        /// <param name="stylesheet">The stylesheet.</param>
        /// <param name="sourceContext">The source Context.</param>
        /// <returns>
        ...
        private static Hashtable GetElementProperties(XmlElement htmlElement, Hashtable inheritedProperties, out Hashtable localProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            switch (elementName)
            {
                ...
                case "italic":
                case "em":
                    localProperties[CssProperties.FontStyle] = CssProperties.FontStyleItalicValue;
                    break;
                case "b":
                case "bold":
                case "strong":
                case "dfn":
                    localProperties[CssProperties.FontWeight] = CssProperties.FontWeightBoldValue;
                    break;
                case "u":
                case "underline":
                    localProperties[CssProperties.TextDecoration] = CssProperties.TextDecorationUnderlineValue;
                    break;
                case "font":
                    string attributeValue = XmlHelper.GetAttribute(htmlElement, "face");
                    if (attributeValue != null)
                    {
                        localProperties[CssProperties.FontFamily] = attributeValue;
                    }

                    attributeValue = XmlHelper.GetAttribute(htmlElement, "size");
                    if (attributeValue != null)
                    {
                        ...
                        localProperties[CssProperties.FontSize] = fontSize.ToString(CultureInfo.InvariantCulture);
                    }

                    attributeValue = XmlHelper.GetAttribute(htmlElement, "color");
                    if (attributeValue != null)
                    {
                        localProperties[CssProperties.Color] = attributeValue;
                    }

                    break;
                case "samp":
                    localProperties[CssProperties.FontFamily] = "Courier New"; // code sample
                    localProperties[CssProperties.FontSize] = XamlProperties.XamlFontSizeXxSmall;
                    localProperties[CssProperties.TextAlign] = "Left";
                    break;
                case "sub":
                    localProperties[CssProperties.FontSize] = XamlProperties.XamlFontSizeXxxSmall;
                    localProperties[CssProperties.BaselineAlign] = XamlProperties.XamlBaselineAlignmentSubscript;
                    break;
                case "sup":
                    localProperties[CssProperties.FontSize] = XamlProperties.XamlFontSizeXxxSmall;
                    localProperties[CssProperties.BaselineAlign] = XamlProperties.XamlBaselineAlignmentSuperscript;
                    break;
                ...
                case "div":
                    ...
                    break;
                case "pre":
                    localProperties[CssProperties.FontFamily] = "Courier New"; // renders text in a fixed-width font
                    localProperties[CssProperties.FontSize] = XamlProperties.XamlFontSizeXxSmall;
                    localProperties[CssProperties.TextAlign] = "Left";
                    break;
                case "blockquote":
                    localProperties[CssProperties.MarginLeft] = "16";
                    break;

                case "h1":
                    localProperties[CssProperties.FontSize] = XamlProperties.XamlFontSizeXxLarge;
                    break;
                case "h2":
                    localProperties[CssProperties.FontSize] = XamlProperties.XamlFontSizeXLarge;
                    break;
                case "h3":
                    localProperties[CssProperties.FontSize] = XamlProperties.XamlFontSizeLarge;
                    break;
                case "h4":
                    localProperties[CssProperties.FontSize] = XamlProperties.XamlFontSizeMedium;
                    break;
                case "h5":
                    localProperties[CssProperties.FontSize] = XamlProperties.XamlFontSizeSmall;
                    break;
                case "h6":
                    localProperties[CssProperties.FontSize] = XamlProperties.XamlFontSizeXSmall;
                    break;
                // List properties
                case "ul":
        ...
        /// <returns>The lengt as double value.</returns>
        ...
        {
            // Parameter validation
            Contract.Assert(htmlChildNode.LocalName.ToLower() == "td" || htmlChildNode.LocalName.ToLower() == "th");
            Contract.Assert(xamlTableCellElement.LocalName == XamlProperties.XamlTableCell);

            // set default border thickness for xamlTableCellElement to enable gridlines
            xamlTableCellElement.SetAttribute(XamlProperties.XamlTableCellBorderThickness, "1,1,1,1");
            xamlTableCellElement.SetAttribute(XamlProperties.XamlTableCellBorderBrush, XamlProperties.XamlBrushesWhite);

            string rowSpanString = XmlHelper.GetAttribute(htmlChildNode, "rowspan");
            if (!string.IsNullOrEmpty(rowSpanString))
            {
                xamlTableCellElement.SetAttribute(XamlProperties.XamlTableCellRowSpan, rowSpanString);
            }

            string align = XmlHelper.GetAttribute(htmlChildNode, "align");
            if (!string.IsNullOrEmpty(align))
            {
                xamlTableCellElement.SetAttribute(XamlProperties.XamlTextAlignment, UppercaseFirst(align));
            }
        }

        /// <summary>
        /// Replaces the first letter in the string to Uppercase letter.
        /// </summary>
        /// <param name="s">The string for uppercasing.</param>
        /// <returns>The string with the first char as uppercase.</returns>
